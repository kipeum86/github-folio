...
| **6 Categories + All** | Filterable grid | Legal AI · Investment · Claude Skills · Content & Web · Obsidian · Fun & Creative |
...
| **Fun & Creative** | 6 | Interior gallery, dashboards archive, AI photo studios |
...
| **6개 카테고리 + 전체** | 필터링 가능한 그리드 | Legal AI · 투자 · Claude Skills · 콘텐츠 & 웹 · Obsidian · Fun & Creative |
...
| **Fun & Creative** | 6 | 인테리어 갤러리, 대시보드 아카이브, AI 포토 스튜디오 |
...
- `legal-agent-orchestrator` — Claude Code 위에서 8명의 전문 리걸 에이전트를 조율하고, 모든 협업 과정을 감사 추적으로 남기는 오케스트레이터.
