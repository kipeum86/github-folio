const translations = {
  ko: {
    ...
    heroTitle4: 'craft',
    heroSub: 'AI 에이전트, 리걸테크, 대시보드, 그리고 개발자 도구 — 각 프로젝트는 엄선되어 일정한 품질 기준에 맞춰 구축되었습니다.',
    scrollHint: '스크롤하여 탐색',
    statRepos: '레포지토리',
    statStars: '스타',
    statCategories: '카테고리',
  ...
  en: {
    ...
    heroTitle3: 'shipped with ',
    heroTitle4: 'craft',
    heroSub: 'AI agents, legal tech, dashboards, and developer tools — each project handpicked and built to a standard.',
